...
# Enhanced Listing
function la { Get-ChildItem -Path . -Force -Exclude NTUSER.* | Format-Table -AutoSize }
function ll { Get-ChildItem -Path . -Force -Hidden | Format-Table -AutoSize }
function l { Get-ChildItem -Path . -Exclude .* | Format-Table -AutoSize }
...
function Get-Theme {
    if (Test-Path -Path $PROFILE.CurrentUserAllHosts -PathType leaf) {
        ...
        oh-my-posh init pwsh --config https://raw.githubusercontent.com/mghenderson/powershell-profile/main/phoenix.omp.json | Invoke-Expression
    }
}
